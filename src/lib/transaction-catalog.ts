...
export const transactionCatalog: readonly TransactionEntry[] = [
  ...
  { id: 'pause', title: 'Pause or resume contributions', role: 'operator', stages: ['raising'], description: 'Queue the campaign settings that stop or restart payments. Pausing alone preserves the cash-out terms.' },
  ...
  { id: 'return', title: 'Return funds to the treasury', role: 'operator', stages: ['funded', 'refunding', 'refunded', 'earning', 'liquidated'], description: 'Approve and add money to the FUND treasury without issuing new FUND. This can restore backing for refunds or sale claims.' },
