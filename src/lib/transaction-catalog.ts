...
export const transactionCatalog: readonly TransactionEntry[] = [
  ...
  { id: 'allowance', title: 'Set or revoke a purchase allowance', role: 'operator', stages: ['funded', 'earning', 'liquidated'], description: 'Review the withdrawal amount under the next ruleset and reconcile prior spending. Asset price and operating budget estimates do not grant withdrawal rights.' },
