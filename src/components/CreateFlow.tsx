            ...
            {step === 2 && <>
              <div className="fundraise-inputs">
                ...
                <fieldset className="income-field-group fundraise-contract"><legend>Contractual settings</legend>
                  <p className="create-help">The owner can change the token name and ticker later.</p>
                  <div className="income-inputs token-inputs">{field('fundTokenName', 'FUND token name', { placeholder: 'e.g. Workshop FUND', maxLength: 32, help: 'Blank uses the project title.' })}{field('fundTicker', 'FUND ticker', { placeholder: 'FUND', maxLength: 12, help: 'The ERC-20 symbol.' })}</div>
                </fieldset>
