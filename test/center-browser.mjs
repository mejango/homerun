...
try {
  ...
  await frame.locator('body').evaluate((_, target) => parent.postMessage({ type: 'juicebox-center:page', page: 'signup' }, target), base)
  ...
  await frame.locator('body').evaluate((_, target) => parent.postMessage({ type: 'juicebox-center:page', page: 'signin' }, target), base)
