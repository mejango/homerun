...
function update(preserveDetails = false) {
  ...
  status.textContent = ({ raising: 'Currently Fundraising', funded: 'Raise Closed', refunding: 'Currently Refunding', refunded: 'Refunds Complete', earning: 'Currently Earning Income', liquidated: 'Asset Sold' })[phase];
