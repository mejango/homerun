  ...
  <section class="create-editor" aria-label="Design the game">
    ...
    <form id="create-form" novalidate>
      ...
      <section class="create-step" data-step-panel="1" aria-labelledby="step-title-1" hidden><h2 id="step-title-1" tabindex="-1">Fundraise</h2>
        <div class="input-purpose"><h3>Agreement settings</h3><p>These amounts set the raise goal; the operator share sets FUND ownership.</p></div><div class="fundraise-inputs">${field('purchaseBudget','Asset price',{prefix:'$'})}${field('opsReserve','Cash reserve',{prefix:'$',help:'Cash set aside to cover operating expenses.'})}${field('operatorFundPercent','Operator FUND ownership',{suffix:'%',help:'Allocated after a successful purchase.'})}
