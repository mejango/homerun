  ...
  <section class="create-editor" aria-label="Design the rules">
    ...
    <form id="create-form" novalidate>
      ...
      <section class="create-step" data-step-panel="1" aria-labelledby="step-title-1" hidden><h2 id="step-title-1" tabindex="-1">Fundraise</h2>
        <div class="input-purpose"><h3>Fundraising plan</h3><p>Blue inputs model the budget and raise goal. Operator ownership is a proposed contract setting.</p></div><div class="fundraise-inputs">${field('purchaseBudget','Asset price',{prefix:'$',help:'Modeling estimate for the raise goal.'})}${field('opsReserve','Cash reserve',{prefix:'$',help:'Modeled operating cash, not a contract withdrawal allowance.'})}${field('operatorFundPercent','Operator FUND ownership',{suffix:'%',help:'Allocated after a successful purchase.'})}
